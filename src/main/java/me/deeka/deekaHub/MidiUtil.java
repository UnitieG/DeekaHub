...
public class MidiUtil {
    ...
    private static void playMidi(Sequence sequence, float tempo, String ID, Player... listeners) {
        try {
            ...
            System.out.println("Error attempting to play a midi file");
            System.out.println(e);
        }
    }

    /**
     * Play a midi file with the given tempo and ID. The ID is the identifier for stopping the midi later.
     * @param file The midi file to play
     * @param tempo The tempo to play the midi at. 1.0f is the default tempo.
     * @param ID The ID for this midi. This is used to stop the midi later.
     * @param listeners The players to play the midi to.
     ...
     * <pre>
     * try {
     *     MidiUtil.playMidi(new File("song.midi"), 1.0f, "song-midi", player);
